...
public final class inReg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
            ...
            String regtype=request.getParameter("regtyp");
            try
            {
                Class.forName("com.mysql.jdbc.Driver").newInstance();
                Connection con= (Connection) DriverManager.getConnection("jdbc:mysql://localhost/constructionexperience","root","");
                Statement st = (Statement) con.createStatement();
                String insert= "insert into registration values ('"+fname+"', '"+lname+"','"+uname+"','"+pass+"','"+cpass+"','"+email+"','"+pnum+"','"+regtype+"')";
